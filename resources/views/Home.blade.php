...
<section class="services" id="services">
  <div class="container">
    ...
    <div class="cards">
      ...
      <article class="card">
        <span class="card-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="8" width="18" height="12" rx="2"/><circle cx="12" cy="14" r="3"/><path d="M16 4h-8l-2 4h12l-2-4z"/></svg>
        </span>
        <h3>Photography & Videography</h3>
        <p>High-quality visual content that captures your brand's essence, engages your audience, and elevates your digital presence.</p>
